 ...
 */
namespace Hackathon\TranslationCollector\Module\I18n\Parser\Adapter\Php\Tokenizer;

use Hackathon\TranslationCollector\Module\I18n\Parser\Adapter\Php\Tokenizer;
...
{
    /**
     * @var \Hackathon\TranslationCollector\Module\I18n\Parser\Adapter\Php\Tokenizer
     */
    ...
    protected function _collectPhrase($phraseTokens)
    {
        $phrase = [];
        if ($phraseTokens) {
            /** @var \Hackathon\TranslationCollector\Module\I18n\Parser\Adapter\Php\Tokenizer\Token $phraseToken */
